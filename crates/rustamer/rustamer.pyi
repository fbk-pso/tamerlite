...
class Effect:
    def __init__(self, fluent: Fluent, value: Expression) -> None: ...
    @property
...
class Fluent:
    ...
    def __eq__(self, other: object) -> bool: ...
    def __hash__(self) -> int: ...
    def __lt__(self, other: Fluent) -> bool: ...
    def __le__(self, other: Fluent) -> bool: ...
    def __gt__(self, other: Fluent) -> bool: ...
    def __ge__(self, other: Fluent) -> bool: ...
    def __repr__(self) -> str: ...
...
class State:
    ...
    def get_value(self, fluent: Fluent) -> ExpressionNode: ...
...
class SearchSpace:
    ...
    ) -> list[tuple[Fraction | None, Action, Fraction | None]] | None: ...
...
class IfReturnType:
    """The declared return type of an interpreted function. A PyO3 simple
    enum -- not an `enum.Enum` subclass -- so members are exposed as
    class-level instances, mirroring `tamerlite.core.search_space.IfReturnType`."""
...
def get_fluents(exp: Expression) -> list[Fluent]: ...
def evaluate(exp: Expression, state: State) -> ExpressionNode: ...
def simplify(
    exp: Expression,
    assignments: dict[Fluent, ExpressionNode],
