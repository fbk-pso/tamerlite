...
if not has_rustamer:
    ...
    from tamerlite.core.heuristics import HFF, HAdd, HMax, CustomHeuristic, RLRank, RLHeuristic
    ...
    from tamerlite.rustamer import HFF, HAdd, HMax, CustomHeuristic, RLRank, RLHeuristic
